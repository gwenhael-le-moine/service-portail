...
angular.module( 'portailApp' )
    .controller( 'CCNCtrl',
                 [ '$rootScope', '$scope', '$state', '$sce', '$window', 'APP_PATH', 'CASES', 'log', 'apps',
                   function( $rootScope, $scope, $state, $sce, $window, APP_PATH, CASES, log, apps ) {
                                                   ...
                                                   tiles: [ { nom: '14-18',
                                                            ...
                                                            { nom: 'Projets archivés',
                                                              ...
                                                              Retrouver et revisitez les travaux des classes sur ces projets, ici.<br/><br/>\
                                                                                   ...
                                                                                   $scope.root.tiles = pad_tiles_tree( add_additional_tile( $scope.root.tiles ) );
                                                                                 } }
                                                          ] };

                               $scope.tree.tiles = pad_tiles_tree( add_additional_tile( $scope.tree.tiles ) );
