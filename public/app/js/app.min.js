...
var e=b.user.new_avatar.image;var d=0<=e.split(",")[0].indexOf("base64")?atob(e.split(",")[1]):unescape(e.split(",")[1]);e=e.split(",")[0].split(":")[1].split(";")[0];for(var f=new Uint8Array(d.length),h=0;h<d.length;h++)f[h]=d.charCodeAt(h);d=new Blob([f],{type:e});a.blob=d};c.src=b.user.new_avatar.image;b.processing=!1})};b.onChange=function(a){e(a.target.files[0])};var k=function(){b.user.new_avatar={image:null,blob:null,width:0,height:0}};b.upload_avatar=function(){b.user.$upload_avatar().then(function(a){k()})};
