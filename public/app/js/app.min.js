...
!0;a.defaults.withCredentials=!0;a.interceptors.push(["$q","$window",function(a,c){return{responseError:function(a){401===a.status&&(c.location.href="/sso/login?ticket\x3dfalse\x26service\x3d"+encodeURIComponent(c.location.href));return a}}}])}]);
...
var e=b.user.new_avatar.image;var d=0<=e.split(",")[0].indexOf("base64")?atob(e.split(",")[1]):unescape(e.split(",")[1]);e=e.split(",")[0].split(":")[1].split(";")[0];for(var h=new Uint8Array(d.length),f=0;f<d.length;f++)h[f]=d.charCodeAt(f);d=new Blob([h],{type:e});a.blob=d};c.src=b.user.new_avatar.image;b.processing=!1})};b.onChange=function(a){e(a.target.files[0])};var k=function(){b.user.new_avatar={image:null,blob:null,width:0,height:0}};b.upload_avatar=function(){b.user.$upload_avatar().then(function(a){k()})};
...
angular.module("portailApp").component("news",{bindings:{edition:"\x3c"},controller:["$sce","Popups","$http","$q","URL_ENT","RANDOM_IMAGES","currentUser",function(a,d,c,b,h,e,k){var f=this;f.newsfeed=[];f.retrieve_news=function(d){var k=moment().subtract(1,"months").toDate().toISOString();c.get(h+"/api/news",{params:{user_id:f.user.id,"pubDate\x3e":k}}).then(function(e){f.newsfeed=_(e.data).map(function(b,c){b.trusted_content=a.trustAsHtml(b.description);b.no_image=_(b.image).isNull();b.pubDate=moment(new Date(b.pubDate)).toDate();
b.image="app/node_modules/laclasse-common-client/images/11_publipostage.svg";return b});f.carouselIndex=0;return _(f.user.profiles).isEmpty()?b.resolve({data:[]}):c.get(h+"/api/structures/"+f.user.active_profile().structure_id+"/rss",{params:{"pubDate\x3e":k}})}).then(function(b){f.newsfeed=f.newsfeed.concat(_(b.data).map(function(b,c){b.trusted_content=a.trustAsHtml(b.content);b.no_image=_(b.image).isNull();b.pubDate=moment(new Date(b.pubDate)).toDate();_(b.image).isNull()&&(b.image=_(e).sample());
return b}))})};f.config_news_fluxes=function(){d.manage_fluxes(function(){f.retrieve_news(!0)},function(){})};f.$onInit=function(){k.get(!1).then(function(a){f.user=a;f.retrieve_news(!1)})}}],template:'\n\x3cul class\x3d"noir" rn-carousel rn-carousel-buffered rn-carousel-auto-slide\x3d"6" rn-carousel-index\x3d"$ctrl.carouselIndex"\x3e\n    \x3cli ng:repeat\x3d"slide in $ctrl.newsfeed | orderBy:\'pubDate\':true" active\x3d"slide.active"\n        ng:class\x3d"{\'publipostage\': slide.title \x3d\x3d \'Publipostage\', \'no-image\': slide.no_image}"\x3e\n        \x3cdiv class\x3d"carousel-image"\n             ng:style\x3d"{\'background-image\': \'url(\' + slide.image + \')\'}"\x3e\x3c/div\x3e\n        \x3cdiv class\x3d"carousel-caption"\x3e\n            \x3cspan class\x3d"pub-date" ng:cloak\x3e{{ slide.pubDate | date:\'medium\' }}\x3c/span\x3e\n            \x3ca href\x3d"{{ slide.link }}" target\x3d"_blank" ng:if\x3d"slide.link !\x3d \'notYetImplemented\'"\x3e\n                \x3ch6 ng:cloak\x3e{{ slide.title }}\x3c/h6\x3e\n            \x3c/a\x3e\n            \x3ch6 ng:if\x3d"slide.link \x3d\x3d \'notYetImplemented\'"\x3e{{ slide.title }}\x3c/h6\x3e\n            \x3cp ng:bind-html\x3d"slide.trusted_content"\x3e\x3c/p\x3e\n        \x3c/div\x3e\n    \x3c/li\x3e\n    \x3cdiv class\x3d"hidden-xs hidden-sm angular-carousel-indicators"\n         rn-carousel-indicators\n         slides\x3d"$ctrl.newsfeed"\n         rn-carousel-index\x3d"$ctrl.carouselIndex"\x3e\n    \x3c/div\x3e\n    \x3cspan class\x3d"hidden-xs hidden-sm floating-button big toggle bouton-config-news blanc"\n          ng:if\x3d"$ctrl.user.is_admin() \x26\x26 $ctrl.edition"\n          ng:click\x3d"$ctrl.config_news_fluxes()"\x3e\x3c/span\x3e\n\x3c/ul\x3e\n'});
angular.module("portailApp").component("portail",{controller:["$sce","$state","$uibModal","$q","CASES","COULEURS","currentUser","Utils","CCN","Tiles","APP_PATH","CACHE_BUSTER","User","Annuaire","URL_ENT","Popups",function(a,d,c,b,h,e,k,f,m,n,q,l,t,u,v,w){var g=this;g.$onInit=function(){k.get(!0).then(function(a){g.user=a;g.prefix=q;g.COULEURS=e;g.CACHE_BUSTER=l;g.get_tile_template=function(a){return{app:"app/views/tile_app.html?v\x3d"+l,back:"app/views/tile_app.html?v\x3d"+l,regroupement:"app/views/tile_regroupement.html?v\x3d"+
l,eleve:"app/views/tile_eleve.html?v\x3d"+l,rn:"app/views/tile_rn.html?v\x3d"+l,ccn:"app/views/tile_ccn.html?v\x3d"+l}[a]};g.filter_criteria={};var c={index:0,taxonomy:"back",name:"\u2190 Retour",description:"Retour",color:"gris3",action:function(){g.tree=g.tiles;g.parent=null}},t=function(){return b.all(_.chain(g.tree.tiles).select(function(a){return _(a).has("configure")&&a.configure}).map(function(a){return n.update(a).$promise}))},x=function(a){var b=function(a){var b=angular.copy(c);b.action=
a.action;return b},e=function(){return function(a){return!0}},p={MAIL:{modify:function(a){k.recent_mail().then(function(b){a.notifications=b.data});return a}},CCNUM:{action:function(){g.modification||(g.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM.html?v\x3d"+l,tiles:f.pad_tiles_tree([c].concat(m.query().map(function(c,d){c.taxonomy="ccn";c.index=d+1;_(c).has("leaves")&&(c.action=function(){g.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM_archives.html?v\x3d"+
l,tiles:[b(a)].concat(c.leaves.map(function(a,b){a.taxonomy="ccn";a.index=b+1;return a}))};g.parent=c});return c})))},g.parent=a)}},GAR:{action:function(){g.modification||k.ressources().then(function(b){g.tree={configurable:!1,filter:e,aside_template:"app/views/aside_RN.html?v\x3d"+l,tiles:f.pad_tiles_tree([c].concat(b.map(function(a,b){a.taxonomy="rn";a.index=b+1;a.icon=q+"/app/node_modules/laclasse-common-client/images/"+("MANUEL"===a.type?"05_validationcompetences.svg":"AUTRE"===a.type?"07_blogs.svg":
"08_ressources.svg");a.color=h[b%16].color;a.action=function(){f.log_and_open_link("GAR",a.url)};return a})))};g.parent=a})}},TROMBI:{action:function(){g.modification||(g.filter_criteria={show_classes:!0,show_groupes_eleves:!0,show_groupes_libres:!0,text:""},g.get_structure=function(a){return u.get_structure(a).then(function(a){return a.data})},k.groups().then(function(e){g.tree={configurable:!1,filter:function(){return function(a){return"back"===a.taxonomy||("regroupement"!==a.taxonomy||_(g.filter_criteria).has("show_classes")&&
g.filter_criteria.show_classes&&"CLS"===a.type||_(g.filter_criteria).has("show_groupes_eleves")&&g.filter_criteria.show_groupes_eleves&&"GRP"===a.type||_(g.filter_criteria).has("show_groupes_libres")&&g.filter_criteria.show_groupes_libres&&"GPL"===a.type)&&(!_(a).has("name")||_(g.filter_criteria.text).isEmpty()||a.name.toUpperCase().includes(g.filter_criteria.text.toUpperCase())||!_(a).has("structure")||_(g.filter_criteria.text).isEmpty()||a.structure.name.toUpperCase().includes(g.filter_criteria.text.toUpperCase()))}},
aside_template:"app/views/aside_TROMBI_regroupements.html?v\x3d"+l,tiles:f.pad_tiles_tree([c].concat(e.map(function(c,e){c.taxonomy="regroupement";c.index=e+1;switch(c.type){case "CLS":c.color="vert";break;case "GRP":c.color="bleu";break;default:c.color="jaune"}c.color+=0===e%2?"":"-moins";c.action=function(){g.filter_criteria.text="";u.get_users(_(c.users).pluck("user_id")).then(function(c){g.tree={configurable:!1,filter:function(){return function(a){return"eleve"!==a.taxonomy||_(g.filter_criteria.text).isEmpty()||
a.lastname.toUpperCase().includes(g.filter_criteria.text.toUpperCase())||a.firstname.toUpperCase().includes(g.filter_criteria.text.toUpperCase())}},aside_template:"app/views/aside_TROMBI_people.html?v\x3d"+l,tiles:f.pad_tiles_tree([b(a)].concat(c.data.map(function(a,b){a.taxonomy="eleve";a.index=b+1;a.color="jaune";a.color+=0===b%2?"":"-moins";a.avatar=(_(a.avatar.match(/^(user|http)/)).isNull()?v+"/":"")+a.avatar;return a})))};g.parent=a})};return c})))};g.parent=a}))}}};a.configure=!1;a.toggle_configure=
function(){t();a.configure?a.configure=!1:(g.tree.tiles.forEach(function(b){b.configure=b===a?!b.configure:!1}),a.configure=!0)};a.update=function(b){void 0===b&&(b=void 0);if(null!=a.id){var c={id:null,application_id:void 0};void 0!=b?(c.id=a.id,b.forEach(function(b){c[b]=a[b]})):c=angular.copy(a);void 0!=c.application_id&&(c.application_id=""==c.application_id?null:c.application_id);n.update(c)}};a.remove=function(){n.delete(a).$promise.then(function(a){r()})};!_(p[a.application_id]).isUndefined()&&
_(p[a.application_id]).has("action")?a.action=p[a.application_id].action:a.action=function(){g.modification||("EXTERNAL"===a.type||_(a.application_id).isNull()||"PRONOTE"===a.application_id||"TELESRV"===a.application_id?f.log_and_open_link("PRONOTE"===a.application_id?"PRONOTE":"EXTERNAL",a.url):d.go("app",{appid:a.application_id}))};!_(p[a.application_id]).isUndefined()&&_(p[a.application_id]).has("modify")&&(a=p[a.application_id].modify(a));return a},r=function(){k.tiles().then(function(a){a.forEach(function(a){a.taxonomy=
"app"});a=_(a).select(function(a){return(7!=moment().month()||a.summer||!_(g.user.profiles).isEmpty()&&!_(["ELV","TUT"]).includes(g.user.active_profile().type))&&(!g.user.profiles||!g.user.active_profile()||g.user.is_admin()||!_(a.hidden).includes(g.user.active_profile().type))&&("MAIL"===a.application_id?_.chain(g.user.emails).pluck("type").includes("Ent").value():!0)}).map(x);a=f.fill_empty_tiles(a);a=_(a).sortBy(function(a){return a.index});a=f.pad_tiles_tree(a);g.tiles={configurable:!0,aside_template:"app/views/aside_news.html?v\x3d"+
l,tiles:a};c.action()})};g.modification=!1;g.edit_tiles=function(){g.modification=!0};g.exit_tiles_edition=function(){g.modification=!1;t().then(function(a){r()})};g.sortable_options={accept:function(a,b){return!0},longTouch:!0,dragEnd:function(a){_(g.tree.tiles).map(function(a,b){_(a).has("id")&&(a.index=b,a.update(["index"]))})},containment:".damier",containerPositioning:"relative",additionalPlaceholderClass:"col-xs-6 col-sm-4 col-md-3 col-lg-3 petite case",clone:!1,allowDuplicates:!1};g.add_tile=
function(a){w.add_tiles(a,function(b){var c=_.chain(a).reject(function(a){return _(a).has("taxonomy")}).pluck("index").value();_(b).each(function(b){b.structure_id=g.user.active_profile().structure_id;if(1>c.length){var e=a.length;a.push({index:e})}else e=c.shift();b.index=e;n.save({},b).$promise.then(function(a){r()})})},function(){})};r()})}}],template:'\n\x3cdiv class\x3d"row portail"\n                                                           ng:if\x3d"$ctrl.user"\x3e\n                                                        \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-4 col-lg-4 aside"\x3e\n                                                          \x3chelp-icon class\x3d"btn-group hidden-xs help-icon"\n                                                                     user\x3d"$ctrl.user"\x3e\x3c/help-icon\x3e\n\n                                                          \x3clogo class\x3d"col-xs-1 col-sm-1 col-md-6 col-lg-6 logolaclasse gris4"\n                                                                user\x3d"$ctrl.user"\x3e\x3c/logo\x3e\n\n                                                          \x3cuser-tile user\x3d"$ctrl.user"\x3e\x3c/user-tile\x3e\n\n                                                          \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-12 col-lg-12 hidden-xs hidden-sm aside-bottom"\n                                                               ng:include\x3d"$ctrl.user.edit_profile ? \'app/views/aside_news.html?v\x3d\' + $ctrl.CACHE_BUSTER : $ctrl.tree.aside_template"\x3e\x3c/div\x3e\n                                                        \x3c/div\x3e\n\n                                                        \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-8 col-lg-8"\x3e\n                                                          \x3cdiv class\x3d"row user-profil"\n                                                               ng:if\x3d"$ctrl.user.edit_profile"\x3e\n                                                            \x3cuser-profile user\x3d"$ctrl.user"\x3e\x3c/user-profile\x3e\n                                                          \x3c/div\x3e\n\n                                                          \x3cdiv class\x3d"row damier gris4"\n                                                               ng:class\x3d"{\'modification\': $ctrl.modification}"\n                                                               ng:if\x3d"!$ctrl.user.edit_profile"\x3e\n\n                                                            \x3cul data-as-sortable\x3d"$ctrl.sortable_options"\n                                                                data-is-disabled\x3d"!$ctrl.modification"\n                                                                ng:model\x3d"$ctrl.tree.tiles"\x3e\n\n                                                              \x3cli ng:repeat\x3d"tile in $ctrl.tree.tiles | filter:$ctrl.tree.filter()"\n                                                                  class\x3d"col-xs-6 col-sm-4 col-md-3 col-lg-3 petite case animate scale-fade-in {{tile.color}}"\n                                                                  data-as-sortable-item\n                                                                  ng:class\x3d"{ \'empty hidden-xs\': !tile.taxonomy }"\x3e\n                                                                \x3cdiv ng:include\x3d"$ctrl.get_tile_template( tile.taxonomy )"\x3e\x3c/div\x3e\n                                                              \x3c/li\x3e\n                                                            \x3c/ul\x3e\n\n                                                            \x3c!-- Mode normal --\x3e\n                                                            \x3cspan class\x3d"hidden-xs hidden-sm floating-button toggle big off blanc"\n                                                                  ng:if\x3d"$ctrl.tree.configurable \x26\x26 $ctrl.user.is_admin() \x26\x26 !$ctrl.modification"\n                                                                  ng:click\x3d"$ctrl.edit_tiles()"\x3e\x3c/span\x3e\n\n                                                            \x3c!-- Mode modification --\x3e\n                                                            \x3cspan class\x3d"hidden-xs hidden-sm floating-button toggle big on gris4"\n                                                                  ng:if\x3d"$ctrl.modification"\n                                                                  ng:click\x3d"$ctrl.exit_tiles_edition()"\x3e\x3c/span\x3e\n\n                                                            \x3cspan class\x3d"floating-button small action1 add-app gris1"\n                                                                  ng:if\x3d"$ctrl.modification"\n                                                                  ng:click\x3d"$ctrl.add_tile( $ctrl.tree.tiles )"\x3e\x3c/span\x3e\n                                                          \x3c/div\x3e\n\n                                                        \x3c/div\x3e\n                                                      \x3c/div\x3e\n'});
...
angular.module("portailApp").service("currentUser",["$http","$resource","$q","URL_ENT","User","Tiles","Annuaire",function(a,d,c,b,h,e,k){var f=this,m=void 0;f.get=function(c){if(_(m).isUndefined()||c)m=a.get(b+"/api/users/current").then(function(a){return new h(a.data)});return m};f.activate_profile=function(c){return f.get(!1).then(function(d){return a({method:"PUT",url:b+"/api/users/"+d.id+"/profiles/"+c,data:{active:!0}})})};f.ressources=function(){return f.get(!1).then(function(a){return k.get_structure_resources(a.active_profile().structure_id).then(function(a){return a.data})})};
f.tiles=function(){return f.get(!1).then(function(a){return _(a.profiles).isEmpty()?k.query_applications().then(function(a){a=_.chain(a).select(function(a){return _(["MAIL","DOC"]).includes(a.application_id)}).map(function(a){a.summer=!0;return a}).value();return c.resolve(a)}):e.query({structure_id:a.active_profile().structure_id}).$promise})};f.groups=function(){return f.get(!1).then(function(d){var e=_.chain(d.profiles).pluck("structure_id").uniq().value(),h=k.get_structures(e),f=_(d.groups).pluck("group_id");
f=_(f).isEmpty()?c.resolve([]):a.get(b+"/api/groups/",{params:{"id[]":f}}).then(function(a){return a.data});var m=c.resolve([]);0<_.chain(d.profiles).pluck("type").intersection(["DIR","ADM","CPE"]).value().length&&(m=a.get(b+"/api/groups/",{params:{"structure_id[]":e}}).then(function(a){return a.data}));return c.all([f,m,h]).then(function(a){var b=a.pop().data;return _.chain(a).flatten().uniq("id").map(function(a){a.structure=_(b).findWhere({id:a.structure_id});return a}).value()})})};f.recent_mail=
function(){return f.get(!1).then(function(c){return a.get(b+"/api/users/"+c.id+"/imapcheck")})}}]);
angular.module("portailApp").service("log",["$http","$state","URL_ENT","APP_PATH","currentUser",function(a,d,c,b,h){this.add=function(e,k,f){h.get(!1).then(function(h){a.post(c+"/api/logs",{application_id:e,user_id:h.id,structure_id:h.active_profile()?h.active_profile().structure_id:"none",profil_id:h.active_profile()?h.active_profile().type:"none",url:_(k).isNull()?b+d.current.url:k,parameters:_(f).isNull()?_(d.params).map(function(a,b){return b+"\x3d"+a}).join("\x26"):f})})}}]);
...
!1;a.selected(c);b.stopImmediatePropagation()};a.selected=function(b){b.selected=!b.selected;a.tiles_selected=0<_(a.available_tiles).select({selected:!0}).length};a.ok=function(){b.close(_(a.available_tiles).select({selected:!0}))};a.cancel=function(){b.dismiss()};n.query_applications().then(function(b){a.available_tiles=a.available_tiles.concat(_.chain(b).uniq(function(a){return a.application_id}).each(function(a){delete a.id;a.taxonomy="app";a.available=function(){return!_.chain(q).reject(function(a){return a.to_delete}).pluck("application_id").contains(a.application_id).value()}}).value());
...
controller:["$scope","$uibModalInstance","currentUser","Flux","CONFIG",function(a,c,d,k,f){a.$ctrl=a;a.nb_articles=_.range(1,11);a.current_flux=[];a.delete=function(b){b.$delete();a.current_flux=_(a.current_flux).difference([b])};a.save=function(b){b.structure_id=a.user.active_profile().structure_id;return _(b).has("id")?b.$update():b.$save()};a.dirtify=function(a){a.dirty=!0};a.add_flux=function(){a.current_flux.push(new k({name:"",url:"",icon:""}))};a.add_default_flux=function(){_(f.news_feed).each(function(b){a.dirtify(b);
...
angular.module("portailApp").service("Utils",["$state","$window","CASES","log",function(a,d,c,b){this.pad_tiles_tree=function(a){return a.concat(_(c.slice(a.length,c.length)).map(function(b,c){return{index:c+a.length,color:b.color+"-moins"}}))};this.fill_empty_tiles=function(a){var b=a.map(function(a){return a.index});0==b.length?_(16).times(function(b){a.push({index:b,color:c[b%c.length].color+"-moins"})}):_.chain(b).max().range().difference(b).each(function(b){a.push({index:b,color:c[b%c.length].color+
"-moins"})});return a};this.log_and_open_link=function(a,c){b.add(a,c,null);d.open(c)};this.go_home=function(){a.go("portail",{},{reload:!0,inherit:!0,notify:!0})}}]);
