...
angular.module("portailApp").component("portail",{controller:["$sce","$state","$uibModal","$q","CASES","COULEURS","currentUser","Utils","CCN","Tiles","APP_PATH","CACHE_BUSTER","User","Annuaire","URL_ENT","Popups",function(a,d,c,b,g,e,k,h,m,p,r,l,q,t,u,v){var f=this;f.$onInit=function(){k.get(!0).then(function(a){f.user=a;f.prefix=r;f.COULEURS=e;f.CACHE_BUSTER=l;f.get_tile_template=function(a){return{app:"app/views/tile_app.html?v\x3d"+l,back:"app/views/tile_app.html?v\x3d"+l,regroupement:"app/views/tile_regroupement.html?v\x3d"+
l,eleve:"app/views/tile_eleve.html?v\x3d"+l,rn:"app/views/tile_rn.html?v\x3d"+l,ccn:"app/views/tile_ccn.html?v\x3d"+l}[a]};f.filter_criteria={};var b={index:0,taxonomy:"back",name:"\u2190 Retour",description:"Retour",color:"gris3",action:function(){f.tree=f.tiles;f.parent=null}},c=function(a){var c=function(a){var c=angular.copy(b);c.action=a.action;return c},e=function(){return function(a){return!0}},n={MAIL:{modify:function(a){k.recent_mail().then(function(b){a.notifications=b.data});return a}},
CCNUM:{action:function(){f.modification||(f.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM.html?v\x3d"+l,tiles:h.pad_tiles_tree([b].concat(m.query().map(function(b,d){b.taxonomy="ccn";b.index=d+1;_(b).has("leaves")&&(b.action=function(){f.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM_archives.html?v\x3d"+l,tiles:[c(a)].concat(b.leaves.map(function(a,b){a.taxonomy="ccn";a.index=b+1;return a}))};f.parent=b});return b})))},f.parent=a)}},GAR:{action:function(){f.modification||
k.ressources().then(function(c){f.tree={configurable:!1,filter:e,aside_template:"app/views/aside_RN.html?v\x3d"+l,tiles:h.pad_tiles_tree([b].concat(c.map(function(a,b){a.taxonomy="rn";a.index=b+1;a.icon=r+"/app/node_modules/laclasse-common-client/images/"+("MANUEL"===a.type?"05_validationcompetences.svg":"AUTRE"===a.type?"07_blogs.svg":"08_ressources.svg");a.color=g[b%16].color;a.action=function(){h.log_and_open_link("GAR",a.url)};return a})))};f.parent=a})}},TROMBI:{action:function(){f.modification||
...
"GRP"===a.type||_(f.filter_criteria).has("show_groupes_libres")&&f.filter_criteria.show_groupes_libres&&"GPL"===a.type)&&(!_(a).has("name")||_(f.filter_criteria.text).isEmpty()||a.name.toUpperCase().includes(f.filter_criteria.text.toUpperCase())||!_(a).has("structure")||_(f.filter_criteria.text).isEmpty()||a.structure.name.toUpperCase().includes(f.filter_criteria.text.toUpperCase()))}},aside_template:"app/views/aside_TROMBI_regroupements.html?v\x3d"+l,tiles:h.pad_tiles_tree([b].concat(e.map(function(b,
e){b.taxonomy="regroupement";b.index=e+1;switch(b.type){case "CLS":b.color="vert";break;case "GRP":b.color="bleu";break;default:b.color="jaune"}b.color+=0===e%2?"":"-moins";b.action=function(){f.filter_criteria.text="";t.get_users(_(b.users).pluck("user_id")).then(function(b){f.tree={configurable:!1,filter:function(){return function(a){return"eleve"!==a.taxonomy||_(f.filter_criteria.text).isEmpty()||a.lastname.toUpperCase().includes(f.filter_criteria.text.toUpperCase())||a.firstname.toUpperCase().includes(f.filter_criteria.text.toUpperCase())}},
aside_template:"app/views/aside_TROMBI_people.html?v\x3d"+l,tiles:h.pad_tiles_tree([c(a)].concat(b.data.map(function(a,b){a.taxonomy="eleve";a.index=b+1;a.color="jaune";a.color+=0===b%2?"":"-moins";a.avatar=(_(a.avatar.match(/^(user|http)/)).isNull()?u+"/":"")+a.avatar;return a})))};f.parent=a})};return b})))};f.parent=a}))}}};a.configure=!1;a.toggle_configure=function(){a.configure&&a.update();f.tree.tiles.forEach(function(b){b.configure=b===a?!b.configure:!1})};a.update=function(){p.update(a)};
a.remove=function(){p.delete(a).$promise.then(function(a){q()})};!_(n[a.application_id]).isUndefined()&&_(n[a.application_id]).has("action")?a.action=n[a.application_id].action:a.action=function(){f.modification||("EXTERNAL"===a.type||_(a.application_id).isNull()||"PRONOTE"===a.application_id?h.log_and_open_link("PRONOTE"===a.application_id?"PRONOTE":"EXTERNAL",a.url):d.go("app",{appid:a.application_id}))};!_(n[a.application_id]).isUndefined()&&_(n[a.application_id]).has("modify")&&(a=n[a.application_id].modify(a));
return a},q=function(){k.tiles().then(function(a){a.forEach(function(a){a.taxonomy="app"});a=_(a).select(function(a){return(7!=moment().month()||a.summer||!_(f.user.profiles).isEmpty()&&!_(["ELV","TUT"]).includes(f.user.active_profile().type))&&(!f.user.profiles||!f.user.active_profile()||f.user.is_admin()||!_(a.hidden).includes(f.user.active_profile().type))&&("MAIL"===a.application_id?_.chain(f.user.emails).pluck("type").includes("Ent").value():!0)}).map(c);a=h.fill_empty_tiles(a);a=_(a).sortBy(function(a){return a.index});
a=h.pad_tiles_tree(a);f.tiles={configurable:!0,aside_template:"app/views/aside_news.html?v\x3d"+l,tiles:a};b.action()})};f.modification=!1;f.edit_tiles=function(){f.modification=!0};a=function(a){_(f.tree.tiles).map(function(a,b){a.index=b;_(a).has("id")&&a.update()})};f.sortable_options={accept:function(a,b){return!0},longTouch:!0,itemMoved:a,orderChanged:a,containment:".damier",containerPositioning:"relative",additionalPlaceholderClass:"col-xs-6 col-sm-4 col-md-3 col-lg-3 petite case",clone:!1,
allowDuplicates:!1};f.add_tile=function(a){v.add_tiles(a,function(b){_(b).each(function(b){var c=_(a).findIndex(function(a){return!_(a).has("taxonomy")});-1===c&&(c=a.length,a.push({index:c}));b.structure_id=f.user.active_profile().structure_id;p.save({},b).$promise.then(function(a){q()})})},function(){})};f.exit_tiles_edition=function(){f.modification=!1;f.tree.tiles.forEach(function(a){_(a).has("configure")&&(a.configure=!1)});q()};q()})}}],template:'\n\x3cdiv class\x3d"row portail"\n     ng:if\x3d"$ctrl.user"\x3e\n  \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-4 col-lg-4 aside"\x3e\n    \x3chelp-icon class\x3d"btn-group hidden-xs help-icon"\n               user\x3d"$ctrl.user"\x3e\x3c/help-icon\x3e\n\n    \x3clogo class\x3d"col-xs-1 col-sm-1 col-md-6 col-lg-6 logolaclasse gris4"\n          user\x3d"$ctrl.user"\x3e\x3c/logo\x3e\n\n    \x3cuser-tile user\x3d"$ctrl.user"\x3e\x3c/user-tile\x3e\n\n    \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-12 col-lg-12 hidden-xs hidden-sm aside-bottom"\n         ng:include\x3d"$ctrl.user.edit_profile ? \'app/views/aside_news.html?v\x3d\' + $ctrl.CACHE_BUSTER : $ctrl.tree.aside_template"\x3e\x3c/div\x3e\n  \x3c/div\x3e\n\n  \x3cdiv class\x3d"col-xs-12 col-sm-12 col-md-8 col-lg-8"\x3e\n    \x3cdiv class\x3d"row user-profil"\n         ng:if\x3d"$ctrl.user.edit_profile"\x3e\n      \x3cuser-profile user\x3d"$ctrl.user"\x3e\x3c/user-profile\x3e\n    \x3c/div\x3e\n\n    \x3cdiv class\x3d"row damier gris4"\n         ng:class\x3d"{\'modification\': $ctrl.modification}"\n         ng:if\x3d"!$ctrl.user.edit_profile"\x3e\n\n      \x3cul data-as-sortable\x3d"$ctrl.sortable_options"\n          data-is-disabled\x3d"!$ctrl.modification"\n          ng:model\x3d"$ctrl.tree.tiles"\x3e\n\n        \x3cli ng:repeat\x3d"tile in $ctrl.tree.tiles | filter:$ctrl.tree.filter() | orderBy:\'index\' track by $index "\n            class\x3d"col-xs-6 col-sm-4 col-md-3 col-lg-3 petite case animate scale-fade-in {{tile.color}}"\n            data-as-sortable-item\n            ng:class\x3d"{ \'empty hidden-xs\': !tile.taxonomy }"\x3e\n          \x3cdiv ng:include\x3d"$ctrl.get_tile_template( tile.taxonomy )"\x3e\x3c/div\x3e\n        \x3c/li\x3e\n      \x3c/ul\x3e\n\n      \x3c!-- Mode normal --\x3e\n      \x3cspan class\x3d"hidden-xs hidden-sm floating-button toggle big off blanc"\n            ng:if\x3d"$ctrl.tree.configurable \x26\x26 $ctrl.user.is_admin() \x26\x26 !$ctrl.modification"\n            ng:click\x3d"$ctrl.edit_tiles()"\x3e\x3c/span\x3e\n\n      \x3c!-- Mode modification --\x3e\n      \x3cspan class\x3d"hidden-xs hidden-sm floating-button toggle big on gris4"\n            ng:if\x3d"$ctrl.modification"\x3e\x3c/span\x3e\n      \x3cspan class\x3d"floating-button small cancel gris3"\n            ng:if\x3d"$ctrl.modification"\n            ng:click\x3d"$ctrl.exit_tiles_edition()"\x3e\x3c/span\x3e\n\n      \x3cspan class\x3d"floating-button small action1 add-app gris1"\n            ng:if\x3d"$ctrl.modification"\n            ng:click\x3d"$ctrl.add_tile( $ctrl.tree.tiles )"\x3e\x3c/span\x3e\n    \x3c/div\x3e\n\n  \x3c/div\x3e\n\x3c/div\x3e\n'});
...
!1;a.selected(c);b.stopImmediatePropagation()};a.selected=function(b){b.selected=!b.selected;a.tiles_selected=0<_(a.available_tiles).select({selected:!0}).length};a.ok=function(){b.close(_(a.available_tiles).select({selected:!0}))};a.cancel=function(){b.dismiss()};p.query_applications().then(function(b){a.available_tiles=a.available_tiles.concat(_.chain(b).uniq(function(a){return a.application_id}).each(function(a){a.taxonomy="app";a.available=function(){return!_.chain(r).reject(function(a){return a.to_delete}).pluck("application_id").contains(a.application_id).value()}}).value());
