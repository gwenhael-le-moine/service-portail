...
angular.module("portailApp").component("portail",{controller:["$sce","$state","$uibModal","$q","CASES","COULEURS","currentUser","Utils","CCN","Tiles","APP_PATH","CACHE_BUSTER","User","Annuaire","URL_ENT","Popups",function(a,d,c,b,h,e,k,g,m,p,q,l,t,u,v,w){var f=this;f.$onInit=function(){k.get(!0).then(function(a){f.user=a;f.prefix=q;f.COULEURS=e;f.CACHE_BUSTER=l;f.get_tile_template=function(a){return{app:"app/views/tile_app.html?v\x3d"+l,back:"app/views/tile_app.html?v\x3d"+l,regroupement:"app/views/tile_regroupement.html?v\x3d"+
l,eleve:"app/views/tile_eleve.html?v\x3d"+l,rn:"app/views/tile_rn.html?v\x3d"+l,ccn:"app/views/tile_ccn.html?v\x3d"+l}[a]};f.filter_criteria={};var c={index:0,taxonomy:"back",name:"\u2190 Retour",description:"Retour",color:"gris3",action:function(){f.tree=f.tiles;f.parent=null}},t=function(){return b.all(_.chain(f.tree.tiles).select(function(a){return _(a).has("configure")&&a.configure}).map(function(a){a.configure=!1;console.log(a);return a.update().$promise}))},x=function(a){var b=function(a){var b=
angular.copy(c);b.action=a.action;return b},e=function(){return function(a){return!0}},n={MAIL:{modify:function(a){k.recent_mail().then(function(b){a.notifications=b.data});return a}},CCNUM:{action:function(){f.modification||(f.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM.html?v\x3d"+l,tiles:g.pad_tiles_tree([c].concat(m.query().map(function(c,d){c.taxonomy="ccn";c.index=d+1;_(c).has("leaves")&&(c.action=function(){f.tree={configurable:!1,filter:e,aside_template:"app/views/aside_CCNUM_archives.html?v\x3d"+
