...
b){_(a).has("id")&&(a.index=b,a.update())})},containment:".damier",containerPositioning:"relative",additionalPlaceholderClass:"col-xs-6 col-sm-4 col-md-3 col-lg-3 petite case",clone:!1,allowDuplicates:!1};f.add_tile=function(a){w.add_tiles(a,function(b){var c=_.chain(a).reject(function(a){return _(a).has("taxonomy")}).pluck("index").sort().value();_(b).each(function(b){b.structure_id=f.user.active_profile().structure_id;if(1>c.length){var e=a.length;a.push({index:e})}else e=c.shift();b.index=e;n.save({},
