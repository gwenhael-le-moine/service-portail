...
"$locale","$q","moment","URL_ENT",function(b,c,g,f,h){var a=this;a.allowed=!1;a.loading=!1;a.period={decr:function(){a.debut.subtract(1,a.period_types.selected+"s");a.retrieve_data()},incr:function(){a.debut.add(1,a.period_types.selected+"s");a.retrieve_data()},reset:function(){a.debut=f().startOf(a.period_types.selected);a.retrieve_data()}};a.types_labels={structure_id:"\u00c9tablissements",application_id:"Tuiles",profil_id:"Profils",user_id:"Utilisateurs",weekday:"Jours",hour:"Heures",url:"URLs"};
