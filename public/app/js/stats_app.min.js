...
angular.module("statsApp",["ui.bootstrap","nvd3","angularMoment","chieffancypants.loadingBar"]).run(["amMoment",function(b){b.changeLocale("fr")}]).config(["$httpProvider",function(b){b.defaults.withCredentials=!0}]).component("stats",{controller:["$http","$locale","$q","moment","URL_ENT",function(b,c,f,e,h){var a=this;a.allowed=!1;a.loading=!1;a.period={decr:function(){a.debut.subtract(1,a.period_types.selected+"s");a.retrieve_data()},incr:function(){a.debut.add(1,a.period_types.selected+"s");a.retrieve_data()},
reset:function(){a.debut=e().startOf(a.period_types.selected);a.retrieve_data()}};a.types_labels={structure_id:"\u00c9tablissements",application_id:"Tuiles",profil_id:"Profils",user_id:"Utilisateurs",weekday:"Jours",hour:"Heures",url:"URLs"};a.period_types={list:[{label:"journ\u00e9e",value:"day"},{label:"semaine",value:"week"},{label:"mois",value:"month"},{label:"ann\u00e9e",value:"year"}],selected:"week"};["cities","structures_types","profiles_types","structures","applications"].forEach(function(b){a[b]=
{list:[],selected:[]}});a.multibarchart_options={chart:{type:"multiBarChart",x:function(a){return a.x},y:function(a){return a.y},valueFormat:function(a){return a},height:256,width:1050,margin:{left:50,top:20,bottom:100,right:20},showControls:!1,showValues:!0,showLegend:!0,stacked:!1,duration:500,labelThreshold:.01,labelSunbeamLayout:!0,rotateLabels:-25,reduceXTicks:!1,yAxis:{tickFormat:function(a){return d3.format(",.0f")(a)}},xAxis:{}}};a.multibarhorizontalchart_options=angular.copy(a.multibarchart_options);
...
250<b?250:b,a.multibarhorizontalchart_options.chart.xAxis.orient="left",a.multibarhorizontalchart_options.chart.showXAxis=!0,a.multibarhorizontalchart_options;case "url":return a.multibarhorizontalchart_options.chart.height=24*d.length*d[0].values.length+40,a.multibarhorizontalchart_options.chart.xAxis.orient="right",a.multibarhorizontalchart_options.chart.margin.left=10,a.multibarhorizontalchart_options;default:return a.multibarchart_options}};a.labels={weekday:_.memoize(function(a){var b=angular.copy(c.DATETIME_FORMATS.DAY);
b.push(b.shift());return a+" "+b[a]}),hour:function(a){10>a&&(a="0"+a);return a+":00 - "+a+":59"},url:angular.identity};a.process_data=function(b){a.logs=_(b).map(function(a){a.timestamp=e(a.timestamp);a.weekday=a.timestamp.day();a.hour=a.timestamp.hour();return a});a.logs_SSO=_(a.logs).where({application_id:"SSO"});var d=e().subtract(4,"hours");a.totals={clicks:a.logs.length,users:_.chain(a.logs).countBy(function(a){return a.user_id}).size().value(),connections:a.logs_SSO.length,active_connections:_(a.logs_SSO).select(function(a){return a.timestamp.isAfter(d)}).length};
...
_.chain(a.logs).select(function(a){return"url"!=b||null!=a[b].match(/^http.*/)}).countBy(b).value();return[b,[{key:"clicks",values:_.chain(g).keys().map(function(d){return{key:b,value:d,x:a.labels[b](d),y:g[d]}}).sortBy(function(a){switch(b){case "structure_id":case "profil_id":case "url":return-1*a.y;default:return a.x}}).value()}]]}).object().value();var g=function(b,g,d){return _.chain(b).groupBy(function(a){return a[d]}).map(function(b,c){return{x:a.labels[d](c),y:_.chain(b).pluck(g).uniq().value().length}}).value()};
["structure_id","application_id","profil_id","weekday","hour"].forEach(function(b){a.stats[b].push({key:"utilisateurs uniques",values:g(a.logs,"user_id",b)})});a.stats.structure_id.push({key:"apps",values:g(a.logs,"application_id","structure_id")})};a.filter_data=function(b){return _(b).select(function(b){return(0==a.structures_types.selected.length||_.chain(a.structures.list).select(function(b){return _.chain(a.structures_types.selected).pluck("id").contains(b.type).value()}).pluck("id").contains(b.structure_id).value())&&
