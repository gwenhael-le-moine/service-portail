...
var d=["structure_id","application_id","profil_id","weekday","hour"],e=function(b,d){return[{key:"clicks",values:_.chain(d).keys().map(function(k){return{key:b,value:k,x:a.labels[b](k),y:d[k]}}).sortBy(function(a){switch(b){case "structure_id":case "profil_id":return-1*a.y;default:return a.x}}).value()}]},g=function(a,b){return _.chain(b).map(function(b){return[b,e(b,_(a).countBy(b))]}).object().value()};a.stats={};a.stats.global=g(a.logs,d);a.stats.global.structure_id.push({key:"utilisateurs uniques",
